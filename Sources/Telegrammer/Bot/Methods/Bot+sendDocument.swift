...
public extension Bot {
    ...
    public struct SendDocumentParams: MultipartEncodable {
        ...
        public init(chatId: ChatId, document: FileInfo, caption: String? = nil, parseMode: ParseMode? = nil, disableNotification: Bool? = nil, replyToMessageId: Int? = nil, replyMarkup: ReplyMarkup? = nil) {
            self.chatId = chatId
